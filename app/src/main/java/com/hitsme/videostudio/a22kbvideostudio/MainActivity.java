package com.hitsme.videostudio.a22kbvideostudio;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            bundleV.putString("url","http://www.22kb.club/");
            ...
            final Intent intentV=new Intent(this,WebVideoActivity.class);
            final Bundle bundleV=new Bundle();
                    bundleV.putString("url","http://www.22kb.club/movielist/all/1.html");
                    intentV.putExtras(bundleV);
                    startActivity(intentV);
            ...
            final Intent intentV=new Intent(this,WebVideoActivity.class);
            final Bundle bundleV=new Bundle();
            bundleV.putString("url","http://www.22kb.club/tvlist/all/1.html");
            intentV.putExtras(bundleV);
            startActivity(intentV);
        } else if (id == R.id.nav_dongman) {
            final Intent intentV=new Intent(this,WebVideoActivity.class);
            final Bundle bundleV=new Bundle();
            bundleV.putString("url","http://www.22kb.club/dmlist/all/1.html");
            intentV.putExtras(bundleV);
            startActivity(intentV);
        } else if (id == R.id.nav_login) {
            final Intent intentV=new Intent(this,WebVideoActivity.class);
            final Bundle bundleV=new Bundle();
            bundleV.putString("url","http://www.22kb.club/userlogin.html");
            intentV.putExtras(bundleV);
            startActivity(intentV);
        } else if (id == R.id.nav_share) {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + "com.hitsme.22kbvideo.app")));
